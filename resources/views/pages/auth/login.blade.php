    ...
    <div class="font-sans text-gray-900 antialiased container px-6 md:px-20 pt-6 md:pt-16">
        <div class="flex justify-center items-center">
            <div class="md:w-96">
                ...
                <form method="POST" action="{{ route('prosesLogin') }}" class="mt-4">
                    @csrf
                    {{-- email --}}
                    ...
                    <div>
                        <a href="{{ route('register') }}"
                            class="block py-1 rounded-lg
                         border border-hijau-custom text-hijau-custom w-full mt-4 text-center hover:bg-hijau-custom hover:text-white">Register</a>
                    </div>
                </form>
            </div>
            <div class="hidden md:block md:w-96">
                <div>
                    <img src="{{ asset('image/connect.png') }}" alt="" class="">
                </div>
            </div>
        </div>
    </div>
